...
urlpatterns = [
    ...
    path('locations/', views.location_list, name='locations_list'),
    path('locations/new/', views.location_create, name='location_create'),
    path('export/shifts', views.shift_export, name='shift_export'),
    path('export/staff', views.staff_export, name='staff_export'),
